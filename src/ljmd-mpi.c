...
int main(int argc, char **argv)
{
    ...
    if (sys.mpirank == 0) {
        ...
        #ifdef MPIYES
            printf("\nMPI is defined, will run with %d processes.\n", sys.nsize);
        #else
            printf("\nMPI is not defined.\n");
        #endif
        #ifdef _OPENMP
        ...
        #pragma omp master
            ...
            fprintf(stdout, "OpenMP is defined, will use %d threads.\n\n", nthreads);
        #endif
    ...
    MPI_Bcast(&sys.nprint, 1, MPI_INT, 0, sys.mpicomm);
